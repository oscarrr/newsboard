...
#newsboard_plugin_holder .new_holder {
    ...
    margin-bottom: [margin_bottom_holder]px;
...
#newsboard_plugin_holder .new_table tr, th, td {
    padding: 0;
    margin: 0;
    background: none;
    text-align: center;
...
#newsboard_plugin_holder .bar #btn_up {
    background-image: url([plugin_dir]render/img/arrows.png);
}
...
#newsboard_plugin_holder .bar #nbp_logo {
    width: 17px;
    height: 16px;
    background-image: url([plugin_dir]images/logo.png);
    position: absolute;
    margin-top: 3px;
    margin-left: 8px;
    cursor: pointer;
