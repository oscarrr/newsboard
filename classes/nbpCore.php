...
class nbpCore
{
    ...
    public function wp_TWExtFilesLoadInit()
    {
        ...
        wp_enqueue_script( 'nbpMsg-js', $this->pluginPath . "js/nbpMsg.js", array('jquery'), 'free' );
        wp_enqueue_script( 'nbpAnimate-js', $this->pluginPath . "js/nbpAnimate.js", array('jquery'), 'free' );
    }
    ...
    public function ThWExtFilesLoadInit($hook)
    {
        ...
        wp_enqueue_script( 'nbpMsg-js', $this->pluginPath . "js/nbpMsg.js", array('jquery'), 'free' );
        wp_enqueue_script( 'nbpValidate-js', $this->pluginPath . "js/nbpValidate.js", array('jquery'), 'free' );
        wp_enqueue_script( 'nbpThemePick-js', $this->pluginPath . "js/nbpThemePick.js", array('jquery'), 'free' );
    }
